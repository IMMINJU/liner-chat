...
- sonic_link: 한국어 1-2문장. 그 곡의 어떤 요소/구간(예: "2분 30초 무렵의 디스토션 솔로", "마지막 후렴의 비명에 가까운 보컬")이 시드의 어떤 sonic moment와 어떻게 연결되는지 구체적으로. **외부 사실(원칙 7-(1))이 확실하면 그 사실을 문장 앞에 명시** (예: "커트 코베인이 직접 픽시스를 베끼려 했다고 밝힌 곡으로, …"). 단 확실하지 않은 인터뷰/협업 주장은 절대 적지 마라 — 모르면 소닉/계보 묘사만.
